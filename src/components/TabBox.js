                  ...
                  <Nav className="flex-column">
                    <Nav.Item>
                      <Nav.Link eventKey="why">
                        <i className="las la-arrow-right" /> Investment In
                        Kakamega
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="mission">
                        <i className="las la-arrow-right" /> Investment
                        Opportunities
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="vision">
                        <i className="las la-arrow-right" /> Getting Started
                      </Nav.Link>
                    </Nav.Item>
                    {/* <Nav.Item>
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="why">
                      ...
                      <p className="tab-desc">
                        Kakamega County is an agricultural-based economy with
                        sugar cane being the principal cash crop.The county
                        borders Vihiga County to the South, Siaya and Busia
                        Counties to the West, Bungoma and Trans-Nzoia Counties
                        to the North and Nandi and Uasin Gishu Counties to the
                        East. It has 12 sub-counties, 60 electoral wards and 400
                        Community Areas.
                      </p>
                      <ul className="list-unstyled check-list">
                        ...
                        <li>
                          <i className="fa fa-check" />
                          All sectors open to investors with no restrictions.
                        </li>
                        <li>
                          <Link
                    ...
                    <Tab.Pane eventKey="mission">
                      ...
                      <ul className="list-unstyled check-list">
                        <div className="col-md-12">
                          ...
                          <li>
                            <i className="fa fa-check" />
                            Trade, Industrialisation and Tourism.
                          </li>
                          <li>
                            <i className="fa fa-check" />
                            Land, Housing, Urban Areas and Physical Planning.
                          </li>
                          <li>
                            <i className="fa fa-check" />
                    ...
                    <Tab.Pane eventKey="vision">
                      ...
                      <p className="tab-desc">
                        ...
                        establishment of a legal and institutional framework for
                        promotion and co-ordination of investment by the county
                        government of Kakamega and for connected purposes.
                      </p>
                      <ul className="list-unstyled check-list">
                        <li>
                          <i className="fa fa-check" />
