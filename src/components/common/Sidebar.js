            ...
            <div className="sidebar" id="sidebar-body">
                <div className="side-logo d-flex justify-content-between">
                    <div><Link to={process.env.PUBLIC_URL + "/"}><img
                        src={process.env.PUBLIC_URL + "/assets/images/logo-171.png"} alt=""/></Link></div>
                    <div><a href={process.env.PUBLIC_URL + "/"} id="close-sidebar"><i className="las la-times"/></a>
                    </div>
                </div>
                <div className="side-content">
                    <h5>About Us</h5>
                    <p>KCIDA provides the establishment of a legal and institutional framework for promotion and
                        co-ordination of investment by the county government of Kakamega and for connected purposes.</p>
                </div>
                ...
                <div className="side-contact">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li><i className="las la-phone"/>+1 (396) 486 4709</li>
