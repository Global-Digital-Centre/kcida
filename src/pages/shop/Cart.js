                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="product-subtotal">
                            <span className="subtotal">$49.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td className="product-remove">
                          ...
                          <td className="product-subtotal">
                            <span className="subtotal">$39.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td className="product-remove">
                          ...
                          <td className="product-subtotal">
                            <span className="subtotal">$59.00</span>
                          </td>
                        </tr>
                      </tbody>
                    </Table>
                  ...
                  <div className="cart-summary">
                    ...
                    <div className="cs-content">
                      <ul className="list-unstyled">
                        <li>
                          Sub Total <span>$147.00</span>
                        </li>
                        <li>
                          Shipping and Handling <span>$9.00</span>
                        </li>
                        <li>
                          Vat (2.5%) <span>$3.68</span>
                        </li>
                        <li>
                          Discount (10%) <span>$14.70</span>
                        </li>
                      </ul>
                      <p className="cart-total">
                        Grand Total <span>$143.72</span>
                      </p>
