                                    ...
                                    <div className="course-tab-list">
                                        <Tab.Container defaultActiveKey="overview">
                                            <Nav className="flex-column">
                                                ...
                                                <Nav.Item>
                                                    <Nav.Link eventKey="curriculum">More</Nav.Link>
                                                </Nav.Item>
                                                <Nav.Item>
                                                    <Nav.Link eventKey="instructor">Team</Nav.Link>
                                                </Nav.Item>
                                                <Nav.Item>
                                                ...
                                                <Tab.Pane eventKey="curriculum" className="curriculum-tab">
                                                    ...
                                                    <div className="course-element">
                                                        ...
                                                        <div className="course-item">
                                                            <button className="course-button active">Part 1:
                                                                Introduction of
                                                                Investment <span>04 Lectures - 30 Min</span></button>
                                                            <div className="course-content show">
                                                                <ul className="list-unstyled">
                                                                    <li>
                                                                        <span className="play-icon"><i
                                                                            className="las la-play"></i> Lecture: 01</span>
                                                                        <span className="lecture-title">Investment functional components</span>
                                                                        <span className="lecture-duration">02:36</span>
                                                                    </li>
                                                                    <li>
                                                                        <span className="play-icon"><i
                                                                            className="las la-play"></i> Lecture: 02</span>
                                                                        <span className="lecture-title">Investment api integration</span>
                                                                        <span className="lecture-duration">04:20</span>
                                                                    </li>
                                                                    <li>
                                                                        <span className="play-icon"><i
                                                                            className="las la-play"></i> Lecture: 03</span>
                                                                        <span className="lecture-title">Investment project Setup</span>
                                                                        <span className="lecture-duration">03:39</span>
                                                                    </li>
                                                                    <li>
                                                                        <span className="play-icon"><i
                                                                            className="las la-play"></i> Lecture: 04</span>
                                                                        <span
                                                                            className="lecture-title">setup project</span>
                                                        ...
                                                        <div className="course-item">
                                                            <button className="course-button active">Part 2: Investment
                                                                Project Setup <span>03 Lectures - 43 Min</span></button>
                                                            <div className="course-content show">
                                                                <ul className="list-unstyled">
                                                                    <li>
                                                                        <span className="play-icon"><i
                                                        ...
                                                        <div className="course-item">
                                                            <button className="course-button active">Part 3: Setup
                                        ...
                                        <Col md="12">
                                            <div className="course-details-feature">
                                                ...
                                                <ul className="list-unstyled feature-list">
                                                    <li><i className="las la-calendar"></i> Start Date: <span>Aug 21, 200</span>
                                                    </li>
                                                    <li><i className="las la-clock"></i> Duration: <span>1 Year</span>
                                                    </li>
                                                    <li><i className="las la-globe"></i> Language: <span>English</span>
                                                    </li>
                                                    ...
                                                    <li><i
                                                        className="las la-certificate"></i> Certification: <span>Yes</span>
                                                    </li>
                                                </ul>
                                                <a href={process.env.PUBLIC_URL + "/contact"}>
                                                    <button type="button" className="enroll-btn">Contact Us</button>
                                                </a>
                                            </div>
                                        </Col>
                                        <Col md="12">
