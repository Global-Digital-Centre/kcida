                ...
                <div className="course-category">
                    ...
                    <ul className="category-item list-unstyled">
                        <li className="check-btn">
                            <label htmlFor="cat1"><input type="checkbox" id="cat1" className="check-box"/>Kakamega Town</label>
                        </li>
                        <li className="check-btn">
                            <label htmlFor="cat2"><input type="checkbox" id="cat2"
                                                         className="check-box"/>Tourism</label>
                        </li>
                        <li className="check-btn">
                            <label htmlFor="cat3"><input type="checkbox" id="cat3" className="check-box"/>Manufacturing</label>
                        </li>
                        {/*<li className="check-btn">
