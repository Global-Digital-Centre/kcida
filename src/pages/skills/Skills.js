                ...
                <div className="course-details-top">
                      ...
                      <div className="author">
                        <img
                          src={
                            ...
                            `/assets/images/author-280_x_280.png`
                          }
                          alt=""
                        />
                  ...
                  <div className="course-details-banner">
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        `/assets/images/kakamega-town-1920-1161.png`
                      }
                      alt=""
                      className="img-fluid"
                    />
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="overview" className="overview-tab">
                          <div className="course-desc">
                            <h5>Mandate</h5>
                            <p>
                              The County Government of Kakamega established the
                              Kakamega County Investment and Development Agency
                              through an Act of the County Assembly of Kakamega
                              referred to as the Kakamega County Investment and
                              development Agency Act, 2018 to provide for the
                              establishment of a legal and institutional
                              framework for promotion and co-ordination of
                              investment by the county government of Kakamega
                          ...
                          <div className="course-feature">
                            ...
                            <h5>Mission</h5>
                            <p>
                              To attract, promote and facilitate investments in
                              the County.
                            </p>
                            <hr />
                            <h5>Core Values</h5>
                            <ul className="list-unstyled">
                              ...
                              <li>
                                <i className="las la-arrow-right" /> Teamwork
                              </li>
                              <li>
                                <i className="las la-arrow-right" /> Integrity
                              </li>
                              <li>
                                <i className="las la-arrow-right" />
                                Diversity
                          ...
                          <div className="course-learn">
                            ...
                            <p>
                              The strategies and objectives set out in this plan
                              aim to strengthen the core activities of the
                              Agency, as well as invest in strategic initiatives
                              that will focus on the following priority areas:
                            </p>
                            <ul className="list-unstyled">
                              <li>
                                <i className="fa fa-check" /> Priority Area 1:
                                Investment promotion
                              </li>
                              <li>
                                <i className="fa fa-check" /> Priority Area 2:
                                Investment services
                              </li>
                              <li>
                                <i className="fa fa-check" /> Priority Area 3:
                                Networking and partnerships
                              </li>
                              <li>
                                <i className="fa fa-check" /> Priority Area 4:
                        ...
                        >
                          <div className="course-curriculum">
                            ...
                            <p>
                              The KCIDA Office promotes and coordinates sector
                              skills, capacity development strategies and
                              actions to respond to private and public sector
                              needs.
                            </p>
                          </div>
                          <div className="course-element">
                            ...
                            <div className="course-item">
                              <button className="course-button active">
                                Implementation of Capacity Building Fund
                                ...
                                <ul className="list-unstyled">
                                  <li>
                                    <span className="play-icon">
                                      <i className="las la-play" /> Lecture: 01
                                    </span>
                                  ...
                                  <li>
                                    <span className="play-icon">
                                      <i className="las la-play" /> Lecture: 02
                                    </span>
                                    <span className="lecture-title">
                                  ...
                                  <li>
                                    <span className="play-icon">
                                      <i className="las la-play" /> Lecture: 03
                                    </span>
                                    <span className="lecture-title">
                                  ...
                                  <li>
                                    <span className="play-icon">
                                      <i className="las la-play" /> Lecture: 04
                                    </span>
                                    <span className="lecture-title">
                                ...
                                <div className="instructor-content">
                                  <div className="instructor-box">
                                    ...
                                    <div className="instructor-desk">
                                      <p>
                                        The KCIDA Office facilitates labour
                    ...
                    <Col md="12">
                      <div className="course-details-feature">
                        ...
                        <ul className="list-unstyled feature-list">
                          <li>
                            <i className="las la-calendar" /> Start Date:{" "}
                            <span>August, 2018</span>
                          </li>
                          <li>
                            <i className="las la-clock" /> Duration:{" "}
                            <span>4 Year</span>
                          </li>
                        </ul>
                      </div>
